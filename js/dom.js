...
// this method is common for both queen and ruk
...
//    var ar5 = [];
//    for (var i = 0; i < CHESSMANS_IDS.length; i++) {
//        var id = CHESSMANS_IDS[i];
//        var team = checkTeam(id);
//        if (team === atackTeam) {
//            var currentPosition = $("#" + id).parent().attr("id");
//            ar1 = findBishopPath(currentPosition, team, "check");
//            ar2 = findKingPath(currentPosition, team, "check");
//            ar3 = findQueenPath(currentPosition, team, "check");
//            ar4 = findRukPath(currentPosition, team, "check");
//            ar5 = findknightPath(currentPosition, team, "check");
//        }
//        cheackArray = cheackArray.concat(ar1, ar2, ar3, ar4, ar5);
//
//    }
//
//    var defender = "w-a-king";
//    if (turn !== "w") {
//        defender = "b-a-king";
//    }
//
//    for (var i = 0; i < cheackArray.length; i++) {
//        console.log($("#" + cheackArray[i]).children().attr("id") + "  " + defender);
//        if ($("#" + cheackArray[i]).children().attr("id") === defender) {
//            count++;
//        }
//    }
//    console.log(count);
//    if (count > 7) {
//        checkMateStatus = true;
//        alert("mate");
//    }
...
//    for (var i = 0; i < DIV_IDS.length; i++) {
//        if ($("#" + DIV_IDS[i]).children().length > 0) {
//            var tempId = $("#" + DIV_IDS[i]).children().attr("id");
//            var team = checkTeam(tempId);
//            
//            if (team === turn) {
//                if (tempId.includes("king")) {
//                    var team = findKingPath(tempId, team, "check");
//                    if (team.length === 0) {
//                        return true;
//                    } else {
//                        return false;
